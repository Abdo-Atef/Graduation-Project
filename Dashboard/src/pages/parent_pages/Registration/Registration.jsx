...
export default function Registration() {
  ...
  const signUpSchema=yup.object({
      ...
      childName:yup.string().min(3,"min length 3 character").max(40,"max length is 40 character").required("child name is required"),
                ...
                <div className="row g-2">
                  ...
                  <div className="col-lg-5">
                      ...
                      <form action="" className='p-3' onSubmit={formik.handleSubmit}>
                        ...
                        <p className='mt-3'>Do you have account? <Link to="/parent.login" className={`${style.textColor2}`}>Sign In</Link> </p>
                      </form>
                  </div>
                </div>
            </div>
